...
This file re-exports everything from the canonical location so that all files
inside cogs/battle/ that use:
...
from cogs.core.constants import (
    ...
    LOSING_PENALTY_MULT,
    MIRROR_CHIP_DAMAGE,
    ATTACK_CLASH_DEF_CONVERSION,
    ATTACK_CLASH_MULT,
    SPECIAL_FALLBACK_HP_FRACTION,
    BATTLE_TIMEOUT,
    SKILL_PROMPT_SECONDS,
    SPECIAL_GAUGE_MAX,
